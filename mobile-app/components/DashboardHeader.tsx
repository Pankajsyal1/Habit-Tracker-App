...
const DashboardHeader = ({ stats, onCalendarPress }: DashboardHeaderProps) => {
    ...
    <View className={`flex flex-col gap-6 px-5 pt-2 pb-6 border-b ${isDark ? 'bg-slate-950 border-slate-800/60' : 'bg-white border-slate-200/80'}`}>
      <View className="flex-row items-center justify-between">
        <View className="space-y-1">
          ...
          <View className="flex-row items-center gap-2 pt-1">
            ...
            <View className="flex-row items-center gap-2">
              ...
              <Text className="text-[11px] font-bold text-slate-400">{stats.dailyCount} Main Goals</Text>
            </View>
          </View>
        </View>
        ...
        <TouchableOpacity
          ...
          className={`h-12 w-12 items-center justify-center rounded-2xl border ${isDark ? 'bg-sky-500/10 border-sky-500/20' : 'bg-sky-50 border-sky-100'}`}
        >
        ...
        <View className="flex-1 space-y-2">
          <View className="flex-row items-center justify-between">
            ...
            <Text className="text-[10px] font-bold text-emerald-400">
              {stats.dailyCompleted}/{stats.dailyCount} Done
            </Text>
          </View>
